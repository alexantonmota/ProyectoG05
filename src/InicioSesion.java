...
public class InicioSesion {
	...
	private void initialize() {
		...
		btnNewButton_2.setBackground(Color.ORANGE);
		btnNewButton_2.setFont(new Font(".AppleSystemUIFont", Font.PLAIN, 15));
	...
	protected void ingresar() {
		...
		GestionCliente gestionusuario = new GestionCliente();
		Cliente cliente2 = new Cliente();
		cliente2.setUsername(usuario);
		cliente2.setContrasenya(contrasenya);
		
		Cliente usu = gestionusuario.obtenerusuario(cliente2);
