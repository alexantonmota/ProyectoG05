...
public class Pago {
	...
	private void initialize() {
		...
		lblIntroduceLosDatos.setBounds(-43, 23, 534, 49);
		...
		btnPagar.setBounds(103, 247, 115, 29);
		...
		JLabel lblNewLabel = new JLabel("Fecha cad.");
		lblNewLabel.setFont(new Font(".AppleSystemUIFont", Font.BOLD, 15));
		lblNewLabel.setForeground(Color.ORANGE);
		lblNewLabel.setBounds(55, 156, 126, 16);
		frame3.getContentPane().add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(263, 90, 152, 22);
		...
		lblNewLabel_1.setBounds(338, 156, 18, 16);
